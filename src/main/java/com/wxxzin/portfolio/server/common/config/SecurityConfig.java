...
import com.wxxzin.portfolio.server.common.auth.security.oauth2.handler.OAuth2LoginSuccessHandler;
import com.wxxzin.portfolio.server.common.auth.security.oauth2.service.PrincipalOAuth2UserService;
...
public class SecurityConfig {
    ...
    private static final String [] allowAllUrl = { "/", "/error", "/favicon.ico", "/swagger-ui/**", "/v3/api-docs/**" };
		...
		http
			.oauth2Login(oauth2 -> oauth2
					.authorizationEndpoint((authorization) -> authorization
							.baseUri("/api/v1/user/auth/oauth2")
					)
					...
					.successHandler(new OAuth2LoginSuccessHandler(authenticationService, deviceIdExtractor, deviceIdGenerator))
			);
