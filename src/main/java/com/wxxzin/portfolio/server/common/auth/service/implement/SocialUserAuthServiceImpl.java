...
public class SocialUserAuthServiceImpl implements SocialUserAuthService {
    ...
    @Override
    public UserResponseDTO updateOrRegisterUserForWeb(
        Provider provider,
        OAuth2UserInfo oAuth2UserInfo,
        String accessToken
    ) {
        return updateOrRegisterUser(provider, oAuth2UserInfo, accessToken);
    }
    ...
    public UserAuthResponseDTO updateOrRegisterUserForApp(
        ...
        UserResponseDTO userResponseDTO = updateOrRegisterUser(provider, socialUserRegisterRequestDTO, null);
    ...
    private UserResponseDTO updateOrRegisterUser(
        ...
        if (socialUserEntity == null) {
            return registerUser(provider, oAuth2UserInfo, accessToken);
        } else {
            return updateUser(socialUserEntity, oAuth2UserInfo, accessToken);
        }
    }
    ...
    private UserResponseDTO registerUser(
        ...
        SocialUserEntity socialUserEntity = createSocialUser(baseUserEntity, oAuth2UserInfo.getSocialId(), accessToken);
    ...
    private UserResponseDTO updateUser(
        ...
        socialUserEntity.updateAccessToken(accessToken);
    ...
    private SocialUserEntity createSocialUser(BaseUserEntity baseUserEntity, String socialId, String accessToken) {
